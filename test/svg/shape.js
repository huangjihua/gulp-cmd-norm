...
define('mod/svg/shape',['mod/svg/path','core/utils'],function(require, exports, module) {
    ...
    let Shape = function Shape(container, opts) {
        ...
        // 2018-3-21 add path NodeElement Style
        if(utils.isObject(opts) && opts.trailPathStyle!==undefined){
            this._opts.trailPathStyle = opts.trailPathStyle;
        }
        ...
        //path
        if (this._opts.trailPathStyle) {
            utils.setStyles(svgView.path, this._opts.trailPathStyle);
        }
